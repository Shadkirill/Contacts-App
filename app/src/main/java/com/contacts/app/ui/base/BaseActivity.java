...
import com.contacts.app.di.component.DaggerActivityComponent;
import com.contacts.app.di.module.ActivityModule;
import com.contacts.app.utils.CommonUtils;
import com.contacts.app.utils.NetworkUtils;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((AppCore) getApplication()).getApplicationComponent())
                .build();
    }
